    ...
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <a href="{{ url('/kategori-profesi') }}" class="btn btn-warning">Kembali</a>
            </div>
        </div>
    </div>
@else
    <form action="{{ url('/kategori-profesi/' . $kategori_profesi->kategori_id . '/delete_ajax') }}" method="POST" id="form-delete">
        @csrf
        @method('DELETE')
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response.status) {
                                ...
                                tableKategoriProfesi.ajax.reload(); // Sesuaikan dengan nama DataTable Anda
                            } else {
                                $('.error-text').text('');
